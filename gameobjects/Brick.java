...
public class Brick extends GameObject {
    ...
    public Brick(Vector2 topLeftCorner, Vector2 dimensions, ImageReader imageReader, CollisionStrategy collisionStrategy) {
        super(topLeftCorner, dimensions, imageReader.readImage("assets/brick.png", true));
        this.collisionStrategy = collisionStrategy;
    }

    @Override
    public void onCollisionEnter(GameObject other, Collision collision) {
        System.out.println("Brick collided with: " + other.getClass().getSimpleName());
        collisionStrategy.onCollision(this, other);
    }
}
